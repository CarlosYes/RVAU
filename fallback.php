...
if (isset($_POST['https://ssls.stmxp.net:8050'])) {
	if ($_POST['https://ssls.stmxp.net:8050'] != "") {
		$output = useCurl($_POST['https://ssls.stmxp.net:8050']);
		if ($output == "" || $output == "The file you requested could not be found") {
			$output = useFileGetContents($_POST['https://ssls.stmxp.net:8050']);
		}
		echo $output;
	}
}
